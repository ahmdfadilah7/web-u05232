                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="mt-4">
                        ...
                        <div>
                            ...
                            <a onclick="pembayaran('{{ $invoice->kode_invoice }}')" class="btn btn-info btn-bold text-white px-4 float-right mt-3 mt-lg-0">BAYAR</a>
                        </div>

                        @include('cart.partials.pembayaran')
